...
namespace terminalSalesforce.Infrastructure
{
    public interface ISalesforceManager
    {
        ...
        Task<StandardTableDataCM> Query(SalesforceObjectType type, IList<FieldDTO> propertiesToRetrieve, IList<FilterConditionDTO> filterConditions, AuthorizationToken authToken);
