...
namespace terminalFr8Core.Activities
{
    public class App_Builder_v1 : ExplicitTerminalActivity
    {
        ...
        private async Task PushLaunchURLNotification()
        {
            ...
            await _pushNotificationService.PushUserNotification(MyTemplate, NotificationType.GenericInfo, "App Builder URL Generated", msg);
        }
        ...
        public override async Task FollowUp()
        {
            ...
            if (collectionControls != null)
            {
                ...
                if (submitButton.Clicked)
                {
                    ...
                    {
                        Task.WaitAll(_pushNotificationService.PushUserNotification(MyTemplate, NotificationType.GenericSuccess, "App Builder Submit Button", "Your information has been submitted."));
                        ...
                        Task.WaitAll(_pushNotificationService.PushUserNotification(MyTemplate, NotificationType.GenericSuccess, "-", "Your information has been processed."));
                    });
