...
namespace terminalFr8Core.Actions
{
        ...
        : EnhancedTerminalActivity<GetDataFromFr8Warehouse_v1.ActivityUi>
    {
        ...
        private const string PropertyNamesCrateLabel = "Property Names";
        ...
        protected override async Task Configure(RuntimeCrateManager runtimeCrateManager)
        {
            ...
            if (hasSelectedObject)
            {
                ...
                using (var uow = ObjectFactory.GetInstance<IUnitOfWork>())
                {
                    ...
                    var properties = uow.MultiTenantObjectRepository
                        .ListTypePropertyReferences(mtType.Id);

                    var propertyNamesCrate = Crate.FromContent(
                        PropertyNamesCrateLabel,
                        new FieldDescriptionsCM(
                            properties.Select(x => new FieldDTO(x.Name, x.Name, AvailabilityType.Always))
                        ),
                        AvailabilityType.Always
                    );

                    CurrentActivityStorage.ReplaceByLabel(propertyNamesCrate);
                }
            }
            else
            {
                CurrentActivityStorage.RemoveByLabel(PropertyNamesCrateLabel);
            }
