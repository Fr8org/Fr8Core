...
namespace Hub.Interfaces
{
    public interface IActivity
    {
        ...
        ActivityDO Create(IUnitOfWork uow, int actionTemplateId, string label, int? order, RouteNodeDO parentNode, Guid? authorizationTokenId = null);
       ...
       // string Authenticate(ActionDO curActivityDO);
        ...
        Task<SolutionPageDTO> GetSolutionDocumentation(ActivityDTO curActivityDTO);
        void Delete(Guid id);
