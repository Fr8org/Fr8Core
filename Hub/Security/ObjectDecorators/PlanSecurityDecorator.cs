...
namespace Hub.Security.ObjectDecorators
{
    public class PlanSecurityDecorator : IPlan
    {
        ...
        {
            if (_securityServices.AuthorizeActivity(Privilege.EditObject, planId))
            {
        ...
        {
            if (_securityServices.AuthorizeActivity(Privilege.ReadObject, planId))
            {
        ...
        {
            if (_securityServices.AuthorizeActivity(Privilege.EditObject, containerId))
            {
        ...
        {
            if (_securityServices.AuthorizeActivity(Privilege.ReadObject, curPlanDO.Id))
            {
        ...
        {
            if (_securityServices.AuthorizeActivity(Privilege.EditObject, curPlanId))
            {
        ...
        {
            if (_securityServices.AuthorizeActivity(Privilege.DeleteObject, id))
            {
        ...
        {
            if (_securityServices.AuthorizeActivity(Privilege.ReadObject, planActivityId))
            {
        ...
        {
            if (_securityServices.AuthorizeActivity(Privilege.EditObject, curPlan.Id))
            {
