...
$HealthMonitorCmd = "$RootDir\..\Tests\HealthMonitor\bin\$(BuildConfiguration)\HealthMonitor.exe --email-report --app-name VSO-MASTER --ensure-startup --aiik 9db0241b-6f3d-404d-adeb-3839bcb6e3"
