    ...
    public class PlansController : ApiController
    {
        ...
        */
        ...
        public async Task<IHttpActionResult> Deactivate(Guid planId)
        {
            ...
            var planDeactivateTask = Task.Run(() => eventManager.Publish("RouteDeactivated", ObjectFactory.GetInstance<ISecurityServices>().GetCurrentUser(),
        ...
        {
            //ACTIVATE - activate plan if its inactive
            var eventManager = ObjectFactory.GetInstance<Event>();
            bool inActive = false;
            using (var uow = ObjectFactory.GetInstance<IUnitOfWork>())
            {
            ...
            if (inActive)
            {
                ...
                var planActiveTask = Task.Run(() => eventManager.Publish("RouteActivated", ObjectFactory.GetInstance<ISecurityServices>().GetCurrentAccount
