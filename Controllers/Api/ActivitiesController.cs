...
namespace HubWeb.Controllers
{
    ...
    public class ActivitiesController : ApiController
    {
        ...
        public async Task<IHttpActionResult> Create(Guid actionTemplateId, string label = null, string name = null, int? order = null, Guid? parentNodeId = null, bool createPlan = false, Guid? authorizationTokenId = null)
        {
            using (var uow = ObjectFactory.GetInstance<IUnitOfWork>())
            {
                var userId = User.Identity.GetUserId();

                var result = await _activity.CreateAndConfigure(uow, userId, actionTemplateId, label, name, order, parentNodeId, createPlan, authorizationTokenId);
