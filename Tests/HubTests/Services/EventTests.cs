...
namespace HubTests.Services
{
    ...
    public class ActivityMock : IActivity
    {
        ...
        public Task<PlanNodeDO> CreateAndConfigure(IUnitOfWork uow, string userId, Guid actionTemplateId, string label = null, string name = null, int? order = null, Guid? parentNodeId = null, bool createPlan = false, Guid? authorizationTokenId = null)
        {
            return _activity.CreateAndConfigure(uow, userId, actionTemplateId, label, name, order, parentNodeId, createPlan, authorizationTokenId);
        }
