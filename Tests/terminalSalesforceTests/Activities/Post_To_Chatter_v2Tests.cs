...
namespace terminalSalesforceTests.Activities
{
    ...
    public class Post_To_Chatter_v2Tests : BaseTest
    {
        ...
        public override void SetUp()
        {
            ...
            salesforceManagerMock.Setup(x => x.Query(SalesforceObjectType.Account, It.IsAny<IList<FieldDTO>>(), It.IsAny<IList<FilterConditionDTO>>(), It.IsAny<AuthorizationToken>()))
        ...
        public async Task Run_WhenQueriesSalesforceAndNothingIsReturned_ReturnsSuccessButNoPayload()
        {
            ...
            ObjectFactory.GetInstance<Mock<ISalesforceManager>>().Setup(x => x.Query(It.IsAny<SalesforceObjectType>(), It.IsAny<IList<FieldDTO>>(), It.IsAny<IList<FilterConditionDTO>>(), It.IsAny<AuthorizationToken>()))
