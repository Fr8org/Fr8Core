...
namespace terminalDocuSignTests.Integration
{
    ...
    public class Record_DocuSign_Events_v1_Tests : BaseTerminalIntegrationTest
    {
        ...
        [ExpectedException(
            ...
            ExpectedMessage = @"{""status"":""terminal_error"",""message"":""No AuthToken provided."",""userMessage"":""Failed to configure activity \""Record DocuSign\"". Please, make sure it is configured correctly. ""}",
