...
namespace DockyardTest.Repositories.Plan
{
    ...
    public class RouteSnapshotTests : BaseTest
    {
        ...
        private RouteNodeDO GenerateChangedTree_v1()
        {
            return new ActivityDO
            {
                Id = new Guid(1, (short)0, (short)0, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0),
        ...
        private RouteNodeDO GenerateChangedTree_v3()
        {
            return new ActivityDO
            {
                Id = new Guid(1, (short)0, (short)0, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0),
        ...
        private RouteNodeDO GenerateChangedTree_v2()
        {
            return new ActivityDO
            {
                Id = new Guid(1, (short)0, (short)0, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0),
        ...
        {
            var snapshot1 = new RouteSnapshot(GenerateRefTree(), false);
            var snapshot2 = new RouteSnapshot(GenerateChangedTree_v1(), false);
        ...
        {
            var snapshot1 = new RouteSnapshot(GenerateRefTree(), false);
            var snapshot2 = new RouteSnapshot(GenerateChangedTree_v2(), false);
        ...
        {
            var snapshot1 = new RouteSnapshot(GenerateRefTree(), false);
            var snapshot2 = new RouteSnapshot(GenerateChangedTree_v3(), false);
