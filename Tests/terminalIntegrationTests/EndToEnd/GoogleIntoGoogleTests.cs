...
namespace terminalIntegrationTests.EndToEnd
{
    ...
    public class GoogleIntoGoogleTests : BaseHubIntegrationTest
    {
        ...
        /// initial configuration and it does not appear in the spreadsheet list
        /// </summary>
        [Test, Category("Integration.terminalGoogle")]
        public async Task Get_Google_Sheet_Data_v1_FollowupConfiguration_UpdatesSpreadsheetList()
        {
            ...
            try
            {
                ...
                var monitorFormResponses = await _googleActivityConfigurator.(thePlan, 1, sourceSpreadsheetName, true);
