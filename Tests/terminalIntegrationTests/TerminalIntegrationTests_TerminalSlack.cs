...
using StructureMap;
using terminalSlack.Controllers;
...
namespace terminalIntegrationTests
{
    ...
    {
        [Test]
        public void TerminalSlack_DiscoverTerminals_ShouldReturnDataInCorrectFormat()
        {
            //Arrange
            ...
            //Assert
            Assert.IsNotNull(result, "The terminal discovery has failed for Terminal Slack");
