...
namespace TerminalBase.Infrastructure
{
    public interface IHubCommunicator
    {
        ...
        Task<ActivityDTO> CreateAndConfigureActivity(Guid templateId, string userId, string label = null, string name = null, int? order = null, Guid? parentNodeId = null, bool createPlan = false, Guid? authorizationTokenId = null);
