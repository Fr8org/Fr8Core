...
//    public delegate ConfigurationRequestType ConfigurationEvaluator(ActivityPayload curActivityPayload);
...
//        public virtual async Task<PayloadDTO> ExecuteChildActivities(ActivityPayload curTerminalActivity, Guid containerId, AuthorizationTokenDTO authTokenDTO)
//        {
//            return Success(await GetPayload(curTerminalActivity, containerId));
//        }

//        protected bool CheckAuthentication(ActivityPayload activity, AuthorizationTokenDTO authTokenDTO)
//        {
...
//        protected void AddAuthenticationCrate(ActivityPayload terminalActivity, bool revocation)
//        {
//            using (var crateStorage = CrateManager.UpdateStorage(terminalActivity.CrateStorage))
//            {
//                var terminalAuthType = terminalActivity.ActivityTemplate.Terminal.AuthenticationType;
...
//        protected async Task<PayloadDTO> GetPayload(ActivityPayload terminalActivity, Guid containerId)
//        {
//            return await HubCommunicator.GetPayload(terminalActivity, containerId, CurrentFr8UserId);
//        }
//        protected async Task<UserDTO> GetCurrentUserData(ActivityPayload terminalActivity, Guid containerId)
//        {
//            return await HubCommunicator.GetCurrentUser(terminalActivity, containerId, CurrentFr8UserId);
//        }
...
//        protected virtual async Task<ICrateStorage> ValidateActivity(ActivityPayload curTerminalActivity)
//        {
//            return await Task.FromResult<ICrateStorage>(null);
//        }

//        protected async Task<ActivityPayload> ProcessConfigurationRequest(ActivityPayload curTerminalActivity, ConfigurationEvaluator configurationEvaluationResult, AuthorizationTokenDTO authToken)
//        {
//            var configRequestType = configurationEvaluationResult(curTerminalActivity);
//            if (configRequestType == ConfigurationRequestType.Initial)
//            {
//                return await InitialConfigurationResponse(curTerminalActivity, authToken);
//            }

//            else if (configRequestType == ConfigurationRequestType.Followup)
//            {
//                var validationErrors = await ValidateActivity(curTerminalActivity);
//                if (validationErrors != null)
//                {
//                    using (var crateStorage = CrateManager.GetUpdatableStorage(curTerminalActivity))
//                    {
//                        crateStorage.AddRange(validationErrors);
//                    }
//                    return curTerminalActivity;
//                }
...
//                var result = await FollowupConfigurationResponse(curTerminalActivity, authToken);
...
//        private void UpdateRuntimeAvailableCrates(TerminalActivity curTerminalActivity)
//        {
//            using (var activityStorage = CrateManager.GetUpdatableStorage(curTerminalActivity))
//            {
//                activityStorage.RemoveByLabel(RuntimeAvailableCratesLabel);
//                var crateDescriptions = GetRuntimeAvailableCrateDescriptions(curTerminalActivity)?.ToArray();
...
//        /// </summary>
//        protected virtual IEnumerable<CrateDescriptionDTO> GetRuntimeAvailableCrateDescriptions(TerminalActivity curTerminalActivity)
//        {
//            yield break;
//        }
...
//        /// </summary>
//        public virtual async Task<TerminalActivity> Configure(TerminalActivity terminalActivity, AuthorizationTokenDTO authTokenDTO)
//        {
//            return await ProcessConfigurationRequest(terminalActivity, ConfigurationEvaluator, authTokenDTO);
//        }
...
//        /// <returns></returns>
//        public virtual ConfigurationRequestType ConfigurationEvaluator(TerminalActivity curTerminalActivity)
//        {
...
//        protected virtual async Task<TerminalActivity> InitialConfigurationResponse(TerminalActivity curTerminalActivity, AuthorizationTokenDTO authTokenDTO)
//        {
//            //Returns Task<TerminalActivity> using FromResult as the return type is known
//            return await Task.FromResult<TerminalActivity>(curTerminalActivity);
//        }

//        public virtual async Task<TerminalActivity> Activate(TerminalActivity curTerminalActivity, AuthorizationTokenDTO authTokenDTO)
//        {
//            //Returns Task<TerminalActivity> using FromResult as the return type is known
//            var validationErrors = await ValidateActivity(curTerminalActivity);
//            if (validationErrors != null)
...
//        public virtual async Task<TerminalActivity> Deactivate(TerminalActivity curTerminalActivity)
//        {
//            //Returns Task<TerminalActivity> using FromResult as the return type is known
//            return await Task.FromResult<TerminalActivity>(curTerminalActivity);
//        }
...
//        //if the Action doesn't provide a specific method to override this, we just return the existing CrateStorage, unchanged
//        protected virtual async Task<TerminalActivity> FollowupConfigurationResponse(TerminalActivity curTerminalActivity, AuthorizationTokenDTO authTokenDTO)
//        {
//            //Returns Task<TerminalActivity> using FromResult as the return type is known
//            return await Task.FromResult<TerminalActivity>(curTerminalActivity);
//        }
...
//        protected async Task<TerminalActivity> AddAndConfigureChildActivity(Guid parentActivityId, ActivityTemplateDTO activityTemplate, string name = null, string label = null, int? order = null)
//        {
...
//        protected async Task<TerminalActivity> AddAndConfigureChildActivity(TerminalActivity parent, TerminalActivity activityTemplate, string name = null, string label = null, int? order = null)
//        {
...
//        protected async Task<TerminalActivity> ConfigureChildActivity(TerminalActivity parent, TerminalActivity child)
//        {
...
//        /// </summary>
//        protected string ExtractPayloadFieldValue(ICrateStorage crateStorage, string fieldKey, TerminalActivity curActivity)
//        {
...
//            var fr8UserId = curActivity.AuthToken.UserId;
...
//        public virtual async Task<List<Crate<TManifest>>> GetCratesByDirection<TManifest>(TerminalActivity terminalActivity, CrateDirection direction)
//        {
//            return await HubCommunicator.GetCratesByDirection<TManifest>(terminalActivity, direction, CurrentFr8UserId);
//            // return await Activity.GetCratesByDirection<TManifest>(activityId, direction);
//        }

//        public Task<IncomingCratesDTO> GetAvailableData(TerminalActivity activity, CrateDirection direction = CrateDirection.Upstream, AvailabilityType availability = AvailabilityType.RunTime)
//        {
//            return HubCommunicator.GetAvailableData(activity, direction, availability, CurrentFr8UserId);
//        }

//        //wrapper for support test method
//        public virtual async Task<List<Crate>> GetCratesByDirection(TerminalActivity terminalActivity, CrateDirection direction)
//        {
//            return await HubCommunicator.GetCratesByDirection(terminalActivity, direction, CurrentFr8UserId);
//        }

//        public virtual async Task<FieldDescriptionsCM> GetDesignTimeFields(TerminalActivity terminalActivity, CrateDirection direction, AvailabilityType availability = AvailabilityType.NotSet)
//        {
//            var mergedFields = await HubCommunicator.GetDesignTimeFieldsByDirection(terminalActivity, direction, availability, CurrentFr8UserId);
//            return mergedFields;
//        }

//        public virtual IEnumerable<FieldDTO> GetRequiredFields(TerminalActivity curTerminalActivity, string crateLabel)
//        {
//            using (var crateStorage = CrateManager.GetUpdatableStorage(curTerminalActivity))
//            {
...
//        public virtual async Task<List<CrateManifestType>> BuildUpstreamManifestList(TerminalActivity terminalActivity)
//        {
//            var upstreamCrates = await this.GetCratesByDirection<Fr8Data.Manifests.Manifest>(terminalActivity, CrateDirection.Upstream);
//            return upstreamCrates.Where(x => !ExcludedManifestTypes.Contains(x.ManifestType)).Select(f => f.ManifestType).Distinct().ToList();
//        }

//        public virtual async Task<List<String>> BuildUpstreamCrateLabelList(TerminalActivity terminalActivity)
//        {
//            var curCrates = await this.GetCratesByDirection<Fr8Data.Manifests.Manifest>(terminalActivity, CrateDirection.Upstream);
//            return curCrates.Where(x => !ExcludedManifestTypes.Contains(x.ManifestType)).Select(f => f.Label).Distinct().ToList();
//        }

//        public virtual async Task<Crate<FieldDescriptionsCM>> GetUpstreamManifestListCrate(TerminalActivity terminalActivity)
//        {
//            var manifestList = (await BuildUpstreamManifestList(terminalActivity));
...
//        public virtual async Task<Crate<FieldDescriptionsCM>> GetUpstreamCrateLabelListCrate(TerminalActivity terminalActivity)
//        {
//            var labelList = (await BuildUpstreamCrateLabelList(terminalActivity));
...
//        protected virtual async Task<List<Crate<StandardFileDescriptionCM>>> GetUpstreamFileHandleCrates(TerminalActivity terminalActivity)
//        {
//            return await HubCommunicator.GetCratesByDirection<StandardFileDescriptionCM>(terminalActivity, CrateDirection.Upstream, CurrentFr8UserId);
//        }

//        protected async Task<Crate<FieldDescriptionsCM>> MergeUpstreamFields(TerminalActivity terminalActivity, string label)
//        {
//            var curUpstreamFields = (await GetDesignTimeFields(terminalActivity, CrateDirection.Upstream)).Fields.ToArray();
...
//        /// <returns></returns>
//        protected async Task<Crate> CreateAvailableFieldsCrate(TerminalActivity terminalActivity,
...
//        {
//            var curUpstreamFields = await HubCommunicator.GetDesignTimeFieldsByDirection(terminalActivity, CrateDirection.Upstream, availabilityTypeUpstream, CurrentFr8UserId) ?? new FieldDescriptionsCM();
...
//        protected async Task<Crate<FieldDescriptionsCM>> CreateDesignTimeFieldsCrate(TerminalActivity curTerminalActivity, string label)
//        {
...
//                crates = await GetCratesByDirection<FieldDescriptionsCM>(curTerminalActivity, CrateDirection.Upstream);
//            }
//            catch { }
...
//        protected async Task<StandardTableDataCM> ExtractDataFromUpstreamCrates(string upstreamCrateChooserName, TerminalActivity curTerminalActivity)
//        {
//            var controls = GetConfigurationControls(curTerminalActivity);
...
//            var getUpstreamCrates = (await GetCratesByDirection(curTerminalActivity, CrateDirection.Upstream)).ToArray();
...
//            TerminalActivity curTerminalActivity,
//            string name,
//            string label,
//            bool singleManifest,
...
//        {
//            var crateDescriptions = await GetCratesByDirection<CrateDescriptionCM>(curTerminalActivity, CrateDirection.Upstream);
...
//        protected StandardConfigurationControlsCM GetControlsManifest(TerminalActivity curActivity)
//        {
...
//        protected ControlDefinitionDTO GetControl(TerminalActivity curTerminalActivity, string name, string controlType = null)
//        {
//            var controls = GetConfigurationControls(curTerminalActivity);
...
//        // do not use after EnhancedTerminalActivity is introduced
//        protected string ExtractControlFieldValue(TerminalActivity curTerminalActivity, string fieldName)
//        {
//            var storage = CrateManager.GetStorage(curTerminalActivity);
...
//        /// </summary>
//        protected void SetControlValue(TerminalActivity activity, string controlFullName, object value)
//        {
...
//        // do not use after EnhancedTerminalActivity is introduced
//        protected StandardConfigurationControlsCM GetConfigurationControls(TerminalActivity curTerminalActivity)
//        {
//            var storage = CrateManager.GetStorage(curTerminalActivity);
