...
//                var previousActivityStorage = JToken.Parse(CrateManager.CrateStorageAsStr(activityStorageContents));
//                var currentActivityStorage = JToken.Parse(CrateManager.CrateStorageAsStr(CurrentActivity.CrateStorage));
