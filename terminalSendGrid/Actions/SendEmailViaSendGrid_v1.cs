...
namespace terminalSendGrid.Actions
{
    public class SendEmailViaSendGrid_v1 : BaseTerminalActivity
    {
        ...
        public async Task<PayloadDTO> Run(ActivityDO curActivityDO, Guid containerId, AuthorizationTokenDO authTokenDO)
        {
            ...
            var footerMessage = string.Format("This email was generated by The Fr8 Company as part of the processing of Fr8 Container {0} on behalf of Fr8 User {1}. " +
                                              "For questions about this email or other Fr8 matters, go to www.fr8.co", containerId, authTokenDO.UserDO.FirstName +" "+ authTokenDO.UserDO.LastName);
