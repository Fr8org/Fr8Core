...
using StructureMap;
using terminalSendGrid.Controllers;
...
namespace terminalIntegrationTests
{
    ...
    {
        [Test]
        public void TerminalSendGrid_DiscoverTerminals_ShouldReturnDataInCorrectFormat()
        {
            //Arrange
            ...
            //Assert
            Assert.IsNotNull(result, "The terminal discovery has failed for Terminal SendGrid");
