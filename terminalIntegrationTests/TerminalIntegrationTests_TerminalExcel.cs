...
namespace terminalIntegrationTests
{
    public partial class TerminalIntegrationTests
    {
        ...
        [Test]
        public void TerminalExcel_DisoverTerminals_ShouldReturnDataInCorrectFormat()
        {
            //Arrange
            ...
            //Assert
            Assert.IsNotNull(result, "The terminal discovery has failed for Terminal Excel");
