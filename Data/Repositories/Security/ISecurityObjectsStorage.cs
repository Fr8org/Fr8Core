...
namespace Data.Repositories.Security
{
    public interface ISecurityObjectsStorage
    {
        ...
        int InsertObjectRolePrivilege(ISqlConnectionProvider connectionProvider, Guid objectId, Guid rolePrivilegeId, string dataObjectType);
        ...
        void SetupDefaultSecurityForDataObject(ISqlConnectionProvider connectionProvider, Guid dataObjectId, string dataObjectType);
    }
}
