    ...
    public partial class InitialMigration : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.Activities", t => t.CurrentActivityID)
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.ExternalEventSubscriptions", t => t.Id)
                .ForeignKey("dbo.ProcessTemplates", t => t.DocuSignProcessTemplateId, cascadeDelete: true)
                .Index(t => t.Id)
                .Index(t => t.DocuSignProcessTemplateId);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.ActionLists", "CurrentActivityID", "dbo.Activities");
            ...
            DropForeignKey("dbo.ActionLists", "Id", "dbo.Activities");
            ...
            DropForeignKey("dbo.Actions", "Id", "dbo.Activities");
