namespace Data.Migrations
{
    ...
    public partial class RenamedPluginToTerminal : DbMigration
    {
        public override void Up()
        {
            ...
            AddForeignKey("dbo.Subscriptions", "TerminalId", "dbo.Plugins", "Id", cascadeDelete: true);
            AddForeignKey("dbo.ActivityTemplate", "TerminalId", "dbo.Plugins", "Id");
            AddForeignKey("dbo.AuthorizationTokens", "TerminalID", "dbo.Plugins", "Id");
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.AuthorizationTokens", "TerminalID", "dbo.Plugins");
            DropForeignKey("dbo.ActivityTemplate", "TerminalId", "dbo.Plugins");
            DropForeignKey("dbo.Subscriptions", "TerminalId", "dbo.Plugins");
            DropForeignKey("dbo.Plugins", "TerminalStatus", "dbo._TerminalStatusTemplate");
            DropIndex("dbo.AuthorizationTokens", new[] { "TerminalID" });
            DropIndex("dbo.ActivityTemplate", new[] { "TerminalId" });
            DropIndex("dbo.Plugins", new[] { "TerminalStatus" });
