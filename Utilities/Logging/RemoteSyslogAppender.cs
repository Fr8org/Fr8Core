...
namespace Utilities.Logging.Appender
{
	/// <summary>
	...
	public class fr8RemoteSyslogAppender : UdpAppender
	{
		/// <summary>
		/// Syslog port 514
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="fr8RemoteSyslogAppender" /> class.
		/// </summary>
		/// <remarks>
		/// This instance of the <see cref="fr8RemoteSyslogAppender" /> class is set up to write 
		/// to a remote syslog daemon.
		/// </remarks>
		public fr8RemoteSyslogAppender()
		{
			// syslog udp defaults
