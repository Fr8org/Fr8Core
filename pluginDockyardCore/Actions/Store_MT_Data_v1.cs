...
namespace pluginDockyardCore.Actions
{
    public class Store_MT_Data_v1 : BasePluginAction
    {
        ...
        protected override async Task<ActionDTO> InitialConfigurationResponse(ActionDTO curActionDTO)
        {
            ...
            CrateDTO curMergedUpstreamRunTimeObjects = await MergeUpstreamFields(curActionDO.Id, "Available Run-Time Objects");
            ...
            curActionDO.UpdateCrateStorageDTO(new List<CrateDTO> { curMergedUpstreamRunTimeObjects, curConfigurationControlsCrate, curSelectedObjectType });
