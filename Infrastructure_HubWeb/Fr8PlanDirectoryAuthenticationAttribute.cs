...
namespace HubWeb.Infrastructure_HubWeb
{
    ...
    /// </summary>
    public class Fr8PlanDirectoryAuthenticationAttribute : Attribute, IAuthenticationFilter
    {
        ...
        {
            if (request.Headers.Authorization == null || !request.Headers.Authorization.Scheme.Equals("FR8-PD", StringComparison.OrdinalIgnoreCase)
        ...
        public async Task AuthenticateAsync(HttpAuthenticationContext context, CancellationToken cancellationToken)
        {
            ...
            if (CloudConfigurationManager.GetSetting("PlanDirectorySecret") != terminalToken)
            {
                return;
            }
        ...
        protected class ResultWithChallenge : IHttpActionResult
        {
            ...
            public async Task<HttpResponseMessage> ExecuteAsync(CancellationToken cancellationToken)
            {
                ...
                {
                    response.Headers.WwwAuthenticate.Add(new AuthenticationHeaderValue("FR8-PD"));
                }
