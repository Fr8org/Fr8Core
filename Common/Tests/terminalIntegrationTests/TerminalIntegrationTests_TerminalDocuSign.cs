...
namespace terminalIntegrationTests
{
    ...
    {
        [Test]
        public void TerminalDocuSign_DiscoverTerminals_ShouldReturnDataInCorrectFormat()
        {
            //Arrange
            ...
            //Assert
            Assert.IsNotNull(result, "The terminal discovery has failed for Terminal DocuSign");
