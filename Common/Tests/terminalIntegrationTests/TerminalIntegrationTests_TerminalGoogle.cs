...
namespace terminalIntegrationTests
{
    ...
    {
        [Test]
        public void TerminalGoogle_DiscoverTerminals_ShouldReturnDataInCorrectFormat()
        {
            //Arrange
            ...
            //Assert
            Assert.IsNotNull(result, "The terminal discovery has failed for Terminal Google");
