...
module dockyard.controllers {
    ...
    class PlanListController {
        ...
        private deletePlan(planId: string, isActive: number) {
            ...
            this.$modal.open({
                ...
                controller: 'PlanListController__DeleteConfirmation'
    ...
    */
    app.controller('PlanListController__DeleteConfirmation', ['$scope', '$modalInstance', ($scope: any, $modalInstance: any): void => {
        $scope.ok = () => {
            $modalInstance.close();
        };
